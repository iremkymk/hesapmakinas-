...
<html lang="tr-tr"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./Home2_files/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="./Home2_files/jquery.typeahead.min.css" type="text/css">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    
    <link rel="stylesheet" href="./Home2_files/style.min.css" type="text/css">
    
    <link rel="stylesheet" href="./Home2_files/custom.css" type="text/css">
    <script src="./Home2_files/promise.min.js.indir" type="text/javascript" charset="utf-8"></script>
    <script src="./Home2_files/index.js.indir" type="text/javascript"></script>
    <script src="./Home2_files/index.js(1).indir" type="text/javascript"></script>
    <script src="./Home2_files/index.js(2).indir" type="text/javascript"></script>
    <script src="./Home2_files/require.js.indir" type="text/javascript" charset="utf-8"></script>
    <script>
      require.config({
...
<script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="services/contents" src="./Home2_files/contents.js.indir"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="custom/custom" src="./Home2_files/custom.js.indir"></script></head>
...
<div id="header" style="display: block;">
  ...
  <div id="ipython_notebook" class="nav navbar-brand"><a href="http://localhost:8888/tree?token=059529f7839433083dad8451deded34897d5b71cd9193bec" title="dashboard">
      <img src="./Home2_files/logo.png" alt="Jupyter Notebook">
  </a></div>
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseTwo" class=" collapse in">
                <div class="panel-body">
                  ...
                  <div class="list_item row"><div class="col-md-12"><i class="item_icon running_notebook_icon icon-fixed-width"></i><a class="item_link" href="http://localhost:8888/notebooks/Untitled.ipynb" target="_blank"><span class="item_name">Untitled.ipynb</span></a><span class="file_size pull-right">&nbsp;</span><span class="item_modified pull-right" title="2022-11-03 22:50">birkaç saniye önce</span><div class="item_buttons pull-right"><div class="kernel-name">Python 3</div><button class="btn btn-warning btn-xs">Shutdown</button></div></div></div><div class="list_item row"><div class="col-md-12"><i class="item_icon running_notebook_icon icon-fixed-width"></i><a class="item_link" href="http://localhost:8888/notebooks/Untitled1.ipynb" target="_blank"><span class="item_name">Untitled1.ipynb</span></a><span class="file_size pull-right">&nbsp;</span><span class="item_modified pull-right" title="2022-11-03 22:50">birkaç saniye önce</span><div class="item_buttons pull-right"><div class="kernel-name">Python 3</div><button class="btn btn-warning btn-xs">Shutdown</button></div></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<script src="./Home2_files/main.min.js.indir" type="text/javascript" charset="utf-8"></script>
